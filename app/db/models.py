...
class DataAsset(Base):
    ...
    data_format: Mapped[str] = mapped_column(String(50), nullable=False, default="mixed")
    storage_kind: Mapped[str] = mapped_column(String(50), nullable=False, default="uploaded")
